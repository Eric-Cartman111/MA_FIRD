...
public:
    ...
    std::vector<int> violation_counts;                      // per-customer violation counts
    std::vector<double> penalty_values;                     // per-customer penalty values
    ...
    void recordViolation(int id);
    double penaltyFor(int id) const;
};
